...
class Users(AbstractUser):
    ...
    def save(self, *args, **kwargs):
        ...
        # Check if password is already hashed (starts with pbkdf2_sha256$ or other hash identifiers)
        is_hashed = (
            self.password.startswith("pbdf2_sha256$")
            or self.password.startswith("pbkdf2_sha256$")
            or self.password.startswith("bcrypt$")
            or self.password.startswith("sha1$")
            or self.password.startswith("md5$")
        )
