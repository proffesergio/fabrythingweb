...
export const SUPPORT = {
  ...
  address: '[REGISTERED ADDRESS], Bancharampur, Brahmanbaria, Bangladesh',
};
...
export const PRIVACY = {
  ...
  sections: [
    ...
    {
      h: 'Children',
      body: ['Fabrything is not intended for children under 13, and we do not knowingly collect their data.'],
    },
    {
      h: 'Changes',
...
export const TERMS = {
  ...
  sections: [
    ...
    {
      h: 'Governing law',
      body: ['These terms are governed by the laws of Bangladesh, and disputes fall to the courts of Bangladesh.'],
    },
  ],
};
